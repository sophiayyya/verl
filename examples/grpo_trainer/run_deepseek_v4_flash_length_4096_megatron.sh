#!/usr/bin/env bash
# DeepSeek-V4-Flash-0731: response-length experiment, 40 steps, validation every 10.
# Standalone length-only baseline; the MXFP4 QAT arm is a separate script.
# Plan A: prompt/response 1024/4096, overlong buffer 512 with penalty 1.0,
# clip high 0.28 / dual clip 10.0, no thinking, no QAT; retain TE FP8 training.
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-dsv4-0731-noqat-len4096-40step-val10}
...
# Explicitly disable QAT for both actor and rollout in this length-only recipe.
QAT_ARGS=(
